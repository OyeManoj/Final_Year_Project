...
<center>
 <div class="w3-card-2 w3-round w3-white w3-center" style="width:60%">
    ...
    <h3 class="w3-opacity">Exam Date</h3>
	...
	<br><br>
	<button type="submit" class="w3-btn w3-theme" name='edate'><i class="fa fa-pencil"></i>Exam Date</button>
			  <p><br></p>
	...
	if(isset($_POST['edate']))
	{
		...
		$sel="select * from exam where stream='$stream' and sem='$sem'";
		$rel=$con->query($sel);
...

		{
			...
			echo "<input type='text' class='w3-border w3-padding' name='date' style='width:300px' ><br><br>";
		}
		else
		{	
		echo
		"<input type='text' class='w3-border w3-padding' name='date' style='width:300px' value='".$date."'><br><br>";
	    }
	}
    ?>	
	    </div>
