...
<section class="mbr-footer mbr-section mbr-section-md-padding" id="contacts5-0" style="background-color: rgb(239, 239, 239); padding-top: 90px; padding-bottom: 90px;">
	...
	<table align='center' width='70%' border='1'><tr><td colspan='2' align='center' width='100%'>
	<h4>MY PROFILE</h4><br/><br/>
	</td></tr>
	
	<tr><td width='50%' align='right'>
    <center>
            <div class="mbr-company col-xs-12 col-md-6 col-lg-3" style='width:80%;'>

                <div class="mbr-company card">
                    <!--<img src="assets/images/logo.png" class="card-img-top">-->
                    <div class="card-block">
                        <p class="card-text"><b><?php echo $row['fname']; ?>&nbsp;&nbsp;<?php echo $row['mname']; ?>&nbsp;&nbsp;<?php echo $row['lname']; ?></b></p>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <span class="etl-icon icon-phone mbr-iconfont-company-contacts5"></span></span>
                            <span class="list-group-text"><?php echo $row['mob']; ?><br/></span>
                        </li>
                        <li class="list-group-item">
                            <span class="list-group-icon"><span class="etl-icon icon-map-pin mbr-iconfont-company-contacts5"></span></span>
                            <span class="list-group-text"><?php echo $row['address']; ?><br/></span>
                        </li>
                        <li class="list-group-item active">
                            <span class="list-group-icon"><span class="etl-icon icon-envelope mbr-iconfont-company-contacts5"></span></span>
                            <span class="list-group-text"><a href="mailto:support@mobirise.com"><?php echo $row['email']; ?><br/></a></span>
                        </li>
                    </ul>
                </div>
			...
			<td width='50%'>
			<div class="mbr-footer-content col-xs-12 col-md-6 col-lg-3" style='width:100%'>
                <strong>Department</strong><br><?php echo $row['dep']; ?><br><br><br><strong>Designation</strong><br><?php echo $row['des']; ?>
            </div></td></tr></table>
            </center>
			<?php 
		  }
